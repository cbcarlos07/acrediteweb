                        ...
                        <fieldset>
                            <div class="row">
                                <div class="center-block">
                                    <img class="img-responsive profile-img" src="img/acredite.png" alt="" width="25%">
                                </div>
                            </div>
                            <div class="row">
						 ...
						 <i class="glyphicon glyphicon-user"></i>
                                        ...
                                        <input class="form-control usuario" placeholder="Usu&aacute;rio" name="loginname" id="usuario"  type="text"   style="text-transform: uppercase" required="" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
						 ...
						 <i class="glyphicon glyphicon-wrench"></i>
                                ...
                                <div class="form-group">
                                    <button   class="btn btn-lg btn-danger btn-block" id="btn-login" >Entrar</button>
                                </div>
                                <div class="mensagem">
                                    <p class="alert"></p>
                                </div>
